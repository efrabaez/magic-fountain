    ...
    $.fn.ColorPickerSliders = function(options) {
        ...
        return this.each(function() {
            ...
            function _initSettings() {
                ...
                *Custom for magic
                */
                /*Aquí fueron modificadas nombres y elementos para que no aparezcan en el html*/
            ...
            function _buildHtml() {
                ...
                if (settings.order.hsl !== false) {
                    sliders[settings.order.hsl] = '<div class="cp-slider cp-hslhue cp-transparency"><span>'  + '</span><div class="cp-marker"></div></div><div class="cp-slider cp-hslsaturation cp-transparency" hidden><span>' + settings.labels.hslsaturation + '</span><div class="cp-marker"></div></div><div class="cp-slider cp-hsllightness cp-transparency" hidden><span>' + settings.labels.hsllightness + '</span><div class="cp-marker"></div></div>';
                }
                ...
                if (settings.order.preview !== false) {
                    sliders[settings.order.preview] = '<div class="cp-preview cp-transparency"><input type="text" readonly="readonly" id="mySelectedColor"></div>';
                }
